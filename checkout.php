...
<!-- //breadcrumbs -->
<!-- checkout -->
	<div class="checkout" style="padding: 0px;">
		<div class="container">
    ...
    color: #5b32b4;
    font-size: 48px;
		text-transform:none; margin-bottom: 50px;">Selesaikan Pemesanan Anda</h2>
	...
	<div class="almost-footer" style="width : 50%;">
			<br>
        <br>
		...
		<br>
		<form method="post">
		<input type="submit" style="font-size: 24px; height: 50px" class="form-control btn btn-success" name="checkout" value="I Agree and Check Out" \>
		</form>
			</div>
